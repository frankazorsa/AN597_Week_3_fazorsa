...
```
LH: I would suggest defining your probability so that someone can simply run the entire code and see results. This is just me being picky about visuals I think though. 
...
```
LA: You accidentally set l to 1 in your plot. so your barplot looks way off. 
***
###Question 5:
...
LH: ppois is used for the probability of a range of variables whereas dpois is used for a single discrete variable. 
> I will really appreciate help with the annotations, I still working on it.
LH: It would be helpful you you wrote down your thought process going through the questions using #. This will help you learn more about the code especially if you go and define the variables within the code and state why you used each one. 
